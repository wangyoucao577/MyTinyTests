...
function waitForPlaceSearchNearbyResult_Callback(){
    if (0 != place_search_nearby_global.last_remember_succeed_callback_count
        ...
        // 触发外部的callback
        place_search_nearby_global.allDone_Callback(place_search_global.city_lines, place_search_global.city_stations, place_search_global.city_stations_location, place_search_nearby_global.wait_for_nearby_search_locations);
...
function executePlaceSearchNearbyForCity(allPlaceSearchNearbyDone_Callback, city_lines, city_stations, city_stations_location, city, loc, wait_for_nearby_search_locations){
    ...
    place_search_nearby_global.location = loc;
    place_search_nearby_global.wait_for_nearby_search_locations = wait_for_nearby_search_locations;
